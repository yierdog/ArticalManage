...
function goPage(index) {
    ...
    $.ajax({
        type: "Post",
        url: "../server/ArticleManage.aspx/getartData",
...
function getartArticlecount() {
    $.ajax({
        type: "Post", //http通信传参方式
        url: "../server/ArticleManage.aspx/getartArticleListcount", //服务器端资源
